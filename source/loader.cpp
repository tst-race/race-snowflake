 ...
 */
class SnowflakePluginComms : public IRacePluginComms {
public:
...
extern IRacePluginComms *createPluginComms(IRaceSdkComms *sdk) {
    ...
    return new SnowflakePluginComms;
}
...
const char *const racePluginId = "SnowflakePluginComms";
const char *const racePluginDescription =
    "Plugin Comms Snowflake (Georgetown) " BUILD_VERSION;
